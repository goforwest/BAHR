      ...
      <div className="max-w-4xl mx-auto">
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-6 mb-6">
            ...
            <p className="text-red-700 font-cairo">{error.message}</p>
          </div>
        )}
        ...
        {data && (
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-cairo font-semibold text-gray-700 mb-2">
                  النص:
                </h3>
              ...
              <div>
                ...
                <p className="font-mono text-lg bg-gray-50 p-3 rounded">
                  {data.taqti3}
                </p>
              </div>
              ...
              {data.errors.length > 0 && (
                <div>
                  <h3 className="font-cairo font-semibold text-red-700 mb-2">
                    الأخطاء:
                  </h3>
              ...
              {data.suggestions.length > 0 && (
                <div>
                  <h3 className="font-cairo font-semibold text-blue-700 mb-2">
                    الاقتراحات:
                  </h3>
