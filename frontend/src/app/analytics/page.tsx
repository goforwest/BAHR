    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">الجلسة الحالية</h2>
        ...
        {/* Global Stats */}
        <section>
          <h2 className="text-2xl font-bold text-gray-900 mb-6">الإحصائيات العامة (آخر 7 أيام)</h2>
          ...
          {stats && !loading && (
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                <div className="bg-white rounded-lg shadow p-6">
                  <div className="text-sm text-gray-600 mb-2">إجمالي الجلسات</div>
              ...
              {stats.top_events && stats.top_events.length > 0 && (
                <div className="bg-white rounded-lg shadow p-6">
                  <h3 className="text-lg font-bold text-gray-900 mb-4">الأحداث الأكثر شيوعًا</h3>
