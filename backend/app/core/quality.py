...
class ProsodyError:
    ...
    def to_dict(self) -> Dict:
        ...
        return {
            ...
            "suggestion": (
                {"ar": self.suggestion_ar, "en": self.suggestion_en}
                if self.suggestion_ar
                else None
            ),
        }
...
class QualityAnalyzer:
    ...
    def calculate_quality_score(
        ...
        length_score = self._calculate_length_score(verse_text, taqti3_result, bahr_id)
    ...
    def _calculate_length_score(
        self, verse_text: str, taqti3_result: str, bahr_id: Optional[int]
    ) -> float:
        """
    ...
    def generate_suggestions(
        ...
        if bahr_name_ar and meter_confidence >= 0.85:
            ...
            suggestions.append(
                f"البيت يميل إلى بحر {bahr_name_ar} (ثقة: {meter_confidence*100:.0f}%)"
            )
