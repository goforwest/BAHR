...
from app.core.prosody.zihafat import qabd_transform_letters, khabn_transform_letters, idmar_transform_letters
...
# Note: Tests for other ziḥāfāt (ṬAYY, KAFF, etc.) will be added
